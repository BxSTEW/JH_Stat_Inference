...
Let't get some basic data summary. The size of the data set is 60, 3 with three variables: Len which is the length of the tooth, supplement which is the supplement used, and does which is the amount of supplement given.  
...
## 	Welch Two Sample t-test
## 
## data:  dbl_dose_oj and dbl_dose_vc
...
## 	Welch Two Sample t-test
## 
## data:  full_dose_oj and full_dose_vc
...
## 	Welch Two Sample t-test
## 
## data:  half_dose_oj and half_dose_vc
